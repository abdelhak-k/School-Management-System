/****************************************************************************
** Meta object code from reading C++ file 'Wcreateaccount.h'
**
...
#include "../../school-system/Wcreateaccount.h"
...
#error "The header file 'Wcreateaccount.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSCreateAccountENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSCreateAccountENDCLASS_t qt_meta_stringdata_CLASSCreateAccountENDCLASS = {
    {
        QT_MOC_LITERAL(0, 13),  // "CreateAccount"
        QT_MOC_LITERAL(14, 25),  // "on_Create_account_clicked"
        QT_MOC_LITERAL(40, 0)   // ""
    },
    "CreateAccount",
    "on_Create_account_clicked",
...
Q_CONSTINIT const QMetaObject CreateAccount::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCreateAccountENDCLASS_t,
        ...
        // method 'on_Create_account_clicked'
...
void CreateAccount::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_Create_account_clicked(); break;
        default: ;
        }
    }
    (void)_a;
